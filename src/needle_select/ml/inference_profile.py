...
def resolve_image_scale(
    ...
    *,
    ...
    if explicit_scale is not None:
        return clamp_scale(float(explicit_scale), min_scale, max_scale), None, "explicit_scale"
    ...
    if input_magnification is not None:
        ...
        return clamp_scale(trained / float(input_magnification), min_scale, max_scale), None, "magnification"
    ...
    if auto_scale or mode == "auto":
        ...
        if estimate.selected_scale is not None:
            return float(estimate.selected_scale), estimate, estimate.selected_method
        return 1.0, estimate, "auto_failed_fallback_1.0"
